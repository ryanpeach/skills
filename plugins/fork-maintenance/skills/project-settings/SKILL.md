...
2. In github, make sure the branch protections for `fork` are set to require linear history, block force pushes, and to require pull request reviews before merging.
