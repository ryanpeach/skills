...
- The LLM is not allowed to directly edit code.
  ...
  - The LLM may use skills in the brainrot plugin to suppliment not being able to edit, like [refactoring](../refactoring/) which uses bash tools for deterministic edits.
